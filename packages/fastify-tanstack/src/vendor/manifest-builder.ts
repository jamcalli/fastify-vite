...
// Source: https://github.com/TanStack/router/blob/757d43375fabe6c181176284a70139cd56fcfa22/packages/start-plugin-core/src/start-manifest-plugin/manifestBuilder.ts
...
import { processInlineCssUrls } from './inline-css.ts'
import type {
  ManifestAssetLink,
  ManifestCssLink,
  ManifestScript,
...
import type { InlineCssTemplate } from './inline-css.ts'
...
export function createManifestAssetResolvers(
  ...
  const getAssetPath = (fileName: string) => {
    ...
    // Local mod: `joinURL(base, fileName)` → concat; Vite's base ends in '/'
