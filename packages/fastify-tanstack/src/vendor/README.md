...
|---|---|
| `dev-styles.ts` | [`.../vite/dev-server-plugin/dev-styles.ts`](https://github.com/TanStack/router/blob/0166fe8ba0f3492f26d32eeb50548beae6641a07/packages/start-plugin-core/src/vite/dev-server-plugin/dev-styles.ts) |
