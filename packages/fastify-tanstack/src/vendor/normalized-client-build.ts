...
// Source: https://github.com/TanStack/router/blob/757d43375fabe6c181176284a70139cd56fcfa22/packages/start-plugin-core/src/vite/start-manifest-plugin/normalized-client-build.ts
// See ./LICENSE and ./README.md.

import { getCssAssetSource } from './inline-css.ts'
import type { Rollup } from 'vite'
import type { NormalizedClientBuild, NormalizedClientChunk } from './types.ts'

// Local mod: inlined from @tanstack/router-plugin/src/core/constants.ts
const tsrSplit = 'tsr-split'
// Local mod: inlined from @tanstack/start-plugin-core/src/hydration-constants.ts
