...
test('tanstack-file-based-ts', async (t) => {
  ...
  await t.test('_auth preHandler redirects without session cookie', async (t) => {
  ...
  await t.test('_auth preHandler allows with session cookie', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
  ...
  await t.test('root hooks cascade to all routes', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
  ...
  await t.test('posts loader hits primed cache', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
  ...
  await t.test('dashboard renders ssr-populated session from router context', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'GET',
  ...
  await t.test('route-level preHandler runs alongside cascaded hooks', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'GET',
  ...
  await t.test('unmatched route renders notFoundComponent with 404 status', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
  ...
  await t.test('POST /api/login sets session cookie and redirects to dashboard', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'POST',
  ...
  await t.test('GET /api/get-session returns null without cookie', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
  ...
  await t.test('GET /api/get-session returns user with cookie', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'GET',
  ...
  await t.test('POST /api/login uses submitted username as the session cookie', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'POST',
  ...
  await t.test('POST /api/login honors safe redirect target from form body', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'POST',
  ...
  await t.test('POST /api/login rejects protocol-relative redirect target', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'POST',
  ...
  await t.test('POST /api/logout clears session cookie and redirects to login', async (t) => {
    const server = await main(true)
    t.after(() => server.close())
    const response = await server.inject({
      method: 'POST',
